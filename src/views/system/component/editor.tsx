...
function EditorPage() {
  ...
  return (
    <>
      ...
      <Card title={t('sys.system.system.editor.editorSimple')}>
        <Editor id="sample-editor" sample value={quillSimple} onChange={setQuillSimple} />
      </Card>
      <div className="h-10" />
      <Card title={t('sys.system.system.editor.editorFull')}>
        <Editor
          id="full-editor"
          value={quillFull}
        ...
        />
        <div className="h-4" />
        <Card title={t('sys.system.system.editor.parser')}>{parse(quillFull)}</Card>
      </Card>
      <div className="h-10" />
    </>
  )
